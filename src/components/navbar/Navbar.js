  ...
  const renderMenuButton = () => (
    <div className="block lg:hidden">
      <button
        ...
        class="flex items-center px-3 py-2 border rounded text-white border-white border-dotted hover:border-solid"
      >
        {isExpanded ? (
          <HiOutlineX
            size="1rem"
          ...
          <svg
            class="fill-current h-4 w-4 hover:scale-125 transition"
            viewBox="0 0 20 20"
